...
console.log(report1.generate()); //<h1>отчет номер 1</h1><p>содержание отчета 1</p>
const report2 = new JSONReport("отчет номер 2", "содержание отчета номер 2");
console.log(report2.generate()); //{ title: 'отчет номер 2', content: 'содержание отчета номер 2' } 
class CacheБ {
    constructor() {
        this.cache = new Map();
    }
...
logEvent([new Date(), LogLevel.WARNING, "инфо"]);
var HttpStatus;
(function (HttpStatus) {
